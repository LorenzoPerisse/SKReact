...
E_MIN = 0.001  # MeV
E_MAX = 15.999  # MeV
E_BINS = 8000  # Use tidy numbers
E_INTERVAL = (E_MAX - E_MIN + 0.002) / (E_BINS)
...
# __fuel_makeup_data = {
#     "U_235":  [0.571, 0.571, 0.571, 0.571, 0.571, 0.543, 0.000, 0.538],
#     "Pu_239": [0.299, 0.299, 0.299, 0.299, 0.299, 0.411, 0.081, 0.328],
#     "U_238":  [0.076, 0.076, 0.076, 0.076, 0.076, 0.022, 0.708, 0.078],
#     "Pu_241": [0.054, 0.054, 0.054, 0.054, 0.054, 0.024, 0.212, 0.056],
# }
...
inFileName = "/mnt/c/Users/lolos/Documents/Soft/skreact/SKReact/data/ReactorModel_SKReact.root"
inFile = ROOT.TFile.Open( inFileName , "UPDATE" )
spectrum = inFile.Get( "nspec_Tot" )
spectrum.SetDirectory(0)
hbin = int(spectrum.GetNbinsX()/2)
emin = spectrum.GetBinLowEdge(1)
emax = spectrum.GetBinLowEdge(spectrum.GetNbinsX()+1)
